...
const ShimmerCard = () => {
  return (
    <div data-testid='shimmer-test' className="shimmer-card bg-white p-4 shadow-md rounded-md text-center">
      <div className="flex items-center justify-center mb-4">
        <img src={Shimmer} alt="shimmer" className="w-10 h-10 animate-spin mr-2" />
